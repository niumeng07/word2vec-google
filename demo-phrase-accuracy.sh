make
if [ ! -e /Users/liuda/Local/data/news.2012.en.shuffled.gz ]; then
  wget http://www.statmt.org/wmt14/training-monolingual-news-crawl/news.2012.en.shuffled.gz -O /Users/liuda/Local/data/news.2012.en.shuffled.gz
fi
gzip -c -d /Users/liuda/Local/data/news.2012.en.shuffled.gz > ./news.2012.en.shuffled
###
...
/bin/rm -f ./news.2012.en.shuffled*
